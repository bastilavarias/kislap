              ...
              <TiltCard className="p-6 bg-background border border-border rounded-xl hover:border-primary/50 transition-colors">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {edu.degree && <p className="text-primary font-medium">{edu.degree}</p>}
                    {edu.location && (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground">
                Have a vision? I'm ready to help you realize it. Send me a signal and let's get to
                work.
              </p>
...
export function Kinetic({ project, portfolio, themeMode, onSetThemeMode }: Props) {
