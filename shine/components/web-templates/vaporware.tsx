      ...
      <div className="space-y-4 max-w-4xl mx-auto">
        <VwReveal delay={200}>
          <h1 className="text-4xl md:text-7xl font-black uppercase leading-tight italic transform -skew-x-3">
            <span className="glitch-text" data-text={portfolio.job_title || 'CREATOR'}>
...
const ExperienceEducationSection = ({ portfolio }: { portfolio: Portfolio }) => {
  return (
        ...
        <div className="bg-background border-2 border-primary rounded-lg shadow-[0_0_30px_hsl(var(--primary)/0.2)] overflow-hidden">
          ...
          <div className="p-6 md:p-12 bg-background/95 backdrop-blur">
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <h3 className={`text-3xl font-black italic uppercase ${neonText} text-secondary`}>
                  Uplink
                </h3>
              ...
              <div className="space-y-4">
                {error && (
                  ...
                  >
                    ...
                    <AlertTitle className="font-mono uppercase text-xs">Error: {error}</AlertTitle>
                  </Alert>
                )}
                ...
                <div className="space-y-1">
                  <Label className="text-primary text-xs font-bold uppercase">Target_Mail</Label>
                  <Input
                    {...register('email')}
                    className="bg-muted/30 border-primary/30 focus:border-primary rounded-none font-mono text-sm"
                ...
                <div className="space-y-1">
                  <Label className="text-primary text-xs font-bold uppercase">Frequency</Label>
                  <Input
                ...
                <div className="space-y-1">
                  <Label className="text-primary text-xs font-bold uppercase">Data_Packet</Label>
                  <Textarea
                    {...register('message')}
      ...
      <div className="flex flex-col items-center justify-center gap-6 text-center px-4">
        <div className="space-y-1 text-xs">
          ...
          <p className="text-muted-foreground opacity-70">
            © {new Date().getFullYear()} {portfolio?.name || 'USER'}. ALL RIGHTS RESERVED.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-3 opacity-80 hover:opacity-100 transition-opacity">
          <div className="flex flex-col items-center gap-1">
            <span className="text-[10px] font-bold text-primary flex items-center gap-1.5">
              <span className="text-secondary animate-pulse">✨</span> POWERED BY KISLAP
            </span>
