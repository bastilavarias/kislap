...
export function Form() {
  const [formData, setFormData] = useState({
    ...
    aboutTitle: "About Us",
    about:
      "We are a passionate team delivering excellent results for our clients.",
    ...
    showcase: [
      { imageUrl: "https://via.placeholder.com/600x400", caption: "Sample Work" },
    ],
  ...
  const handleServiceChange = (index: number, field: string, value: string) => {
    setFormData((prev) => ({
      ...prev,
      services: prev.services.map((s: any, i: number) => (i === index ? { ...s, [field]: value } : s)),
    }))
  }
  const addService = () => {
    setFormData((prev) => ({
  ...
  const handleShowcaseChange = (index: number, field: string, value: string) => {
    setFormData((prev) => ({
      ...prev,
      showcase: prev.showcase.map((it: any, i: number) => (i === index ? { ...it, [field]: value } : it)),
    }))
  }
  const addShowcase = () => {
    setFormData((prev) => ({
      ...
      <CardContent>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <Input value={formData.tagline} onChange={(e) => handleInputChange("tagline", e.target.value)} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              ...
              <Input type="color" value={formData.themeColor} onChange={(e) => handleInputChange("themeColor", e.target.value)} className="h-10 p-1" />
            </div>
            <div>
              <Label className="font-medium mb-2">Business Hours</Label>
              <Input value={formData.businessHours} onChange={(e) => handleInputChange("businessHours", e.target.value)} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <Input value={formData.logoUrl} onChange={(e) => handleInputChange("logoUrl", e.target.value)} />
            </div>
            <div>
              <Label className="font-medium mb-2">Favicon URL</Label>
              <Input value={formData.faviconUrl} onChange={(e) => handleInputChange("faviconUrl", e.target.value)} />
            </div>
          </div>

          <div className="mb-6">
            <Label className="font-medium mb-2">Short Description</Label>
            <Textarea value={formData.shortDescription} onChange={(e) => handleInputChange("shortDescription", e.target.value)} className="h-24" />
          </div>
        </section>
        ...
        <section className="mb-8 border-t border-gray-200 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <Input value={formData.facebook} onChange={(e) => handleInputChange("facebook", e.target.value)} />
            </div>
            <div>
              <Label className="text-xs mb-2">Instagram</Label>
              <Input value={formData.instagram} onChange={(e) => handleInputChange("instagram", e.target.value)} />
            </div>
            <div>
            ...
            <div>
              ...
              <Input value={formData.tiktok} onChange={(e) => handleInputChange("tiktok", e.target.value)} />
            </div>
            <div>
            ...
            <div>
              ...
              <Input value={formData.messenger} onChange={(e) => handleInputChange("messenger", e.target.value)} />
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 border-t border-gray-200 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <Input value={formData.heroTitle} onChange={(e) => handleInputChange("heroTitle", e.target.value)} />
            </div>
            <div>
              <Label className="font-medium mb-2">Subheadline</Label>
              <Input value={formData.heroSubtitle} onChange={(e) => handleInputChange("heroSubtitle", e.target.value)} />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              <Label className="font-medium mb-2">Hero Image URL</Label>
              <Input value={formData.heroImageUrl} onChange={(e) => handleInputChange("heroImageUrl", e.target.value)} />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label className="text-xs mb-2">Primary CTA Text</Label>
                <Input value={formData.primaryCtaText} onChange={(e) => handleInputChange("primaryCtaText", e.target.value)} />
              </div>
              <div>
                <Label className="text-xs mb-2">Primary CTA Link</Label>
                <Input value={formData.primaryCtaLink} onChange={(e) => handleInputChange("primaryCtaLink", e.target.value)} />
              </div>
              <div>
                <Label className="text-xs mb-2">Secondary CTA Text</Label>
                <Input value={formData.secondaryCtaText} onChange={(e) => handleInputChange("secondaryCtaText", e.target.value)} />
              </div>
              <div>
                <Label className="text-xs mb-2">Secondary CTA Link</Label>
                <Input value={formData.secondaryCtaLink} onChange={(e) => handleInputChange("secondaryCtaLink", e.target.value)} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 border-t border-gray-200 pt-8" id="about">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <Input value={formData.aboutTitle} onChange={(e) => handleInputChange("aboutTitle", e.target.value)} />
            </div>
            <div>
              <Label className="font-medium mb-2">Team Image URL</Label>
              <Input value={formData.teamImageUrl} onChange={(e) => handleInputChange("teamImageUrl", e.target.value)} />
            </div>
          </div>
          <div className="mb-6">
            <Label className="font-medium mb-2">About Description</Label>
            <Textarea value={formData.about} onChange={(e) => handleInputChange("about", e.target.value)} className="h-28" />
          </div>
        ...
        <section className="border-t border-gray-200 pt-8">
          ...
          <div className="mb-6">
            ...
            <Input value={formData.servicesTitle} onChange={(e) => handleInputChange("servicesTitle", e.target.value)} />
          </div>
          {formData.services.map((service: any, index: number) => (
            <div key={index} className="border-2 border-dashed border-gray-300 rounded p-6 mb-6 space-y-4">
              <div className="flex justify-between items-start">
                <Label className="font-medium">Service Title</Label>
                <Button variant="ghost" size="sm" className="text-gray-400" onClick={() => removeService(index)}>
                  <X className="w-4 h-4" />
                </Button>
              </div>
              ...
              <Textarea value={service.description} onChange={(e) => handleServiceChange(index, "description", e.target.value)} className="h-20" />

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label className="text-xs mb-2">Image URL (optional)</Label>
                  <Input value={service.imageUrl} onChange={(e) => handleServiceChange(index, "imageUrl", e.target.value)} />
                </div>
                <div>
                  <Label className="text-xs mb-2">Price (optional)</Label>
                  <Input value={service.price} onChange={(e) => handleServiceChange(index, "price", e.target.value)} />
                </div>
              </div>
            </div>
          ))}
        ...
        <section className="border-t border-gray-200 pt-8">
          ...
          <div className="mb-6">
            <Label className="font-medium mb-2">Section Title</Label>
            <Input value={formData.showcaseTitle} onChange={(e) => handleInputChange("showcaseTitle", e.target.value)} />
          </div>
          {formData.showcase.map((item: any, index: number) => (
            <div key={index} className="border-2 border-dashed border-gray-300 rounded p-6 mb-6 space-y-4">
              <div className="flex justify-between items-start">
                <Label className="font-medium">Image URL</Label>
                <Button variant="ghost" size="sm" className="text-gray-400" onClick={() => removeShowcase(index)}>
                  <X className="w-4 h-4" />
                </Button>
              </div>
              <Input value={item.imageUrl} onChange={(e) => handleShowcaseChange(index, "imageUrl", e.target.value)} />
              <Label className="font-medium">Caption (optional)</Label>
              <Input value={item.caption} onChange={(e) => handleShowcaseChange(index, "caption", e.target.value)} />
            </div>
          ))}
        </section>
        ...
        <section className="border-t border-gray-200 pt-8">
          ...
          <div className="mb-6">
            <Label className="font-medium mb-2">Section Title</Label>
            <Input value={formData.testimonialsTitle} onChange={(e) => handleInputChange("testimonialsTitle", e.target.value)} />
          </div>
            ...
            <div key={index} className="border-2 border-dashed border-gray-300 rounded p-6 mb-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input value={t.photoUrl} onChange={(e) => handleTestimonialChange(index, "photoUrl", e.target.value)} />
                </div>
              </div>
              <div>
                <Label className="text-xs mb-2">Testimonial</Label>
                <Textarea value={t.text} onChange={(e) => handleTestimonialChange(index, "text", e.target.value)} className="h-20" />
              </div>
              <div className="grid grid-cols-2 gap-4 items-center">
                ...
                <div className="flex justify-end">
                  <Button variant="ghost" size="sm" className="text-gray-400" onClick={() => removeTestimonial(index)}>
                    <X className="w-4 h-4" />
                  </Button>
                </div>
              </div>
        ...
        <section className="border-t border-gray-200 pt-8">
          ...
          <div className="mb-6">
            <Label className="font-medium mb-2">Section Title</Label>
            <Input value={formData.faqTitle} onChange={(e) => handleInputChange("faqTitle", e.target.value)} />
          </div>
          {formData.faqs.map((f: any, index: number) => (
            <div key={index} className="border-2 border-dashed border-gray-300 rounded p-6 mb-6 space-y-4">
              <div>
                <Label className="text-xs mb-2">Question</Label>
                <Input value={f.question} onChange={(e) => handleFaqChange(index, "question", e.target.value)} />
              </div>
              <div>
                <Label className="text-xs mb-2">Answer</Label>
                <Textarea value={f.answer} onChange={(e) => handleFaqChange(index, "answer", e.target.value)} className="h-20" />
              </div>
              <div className="flex justify-end">
                <Button variant="ghost" size="sm" className="text-gray-400" onClick={() => removeFaq(index)}>
                  <X className="w-4 h-4" />
                </Button>
              </div>
            </div>
        ...
        <section className="border-t border-gray-200 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              <Label className="font-medium mb-2">Headline</Label>
              <Input value={formData.ctaHeadline} onChange={(e) => handleInputChange("ctaHeadline", e.target.value)} />
            </div>
            <div>
              <Label className="font-medium mb-2">Subtext</Label>
              <Input value={formData.ctaSubtext} onChange={(e) => handleInputChange("ctaSubtext", e.target.value)} />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <Label className="text-xs mb-2">Button Text</Label>
              <Input value={formData.ctaButtonText} onChange={(e) => handleInputChange("ctaButtonText", e.target.value)} />
            </div>
            <div>
              <Label className="text-xs mb-2">Button Link</Label>
              <Input value={formData.ctaButtonLink} onChange={(e) => handleInputChange("ctaButtonLink", e.target.value)} />
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-gray-200 pt-8">
          ...
          <div className="mb-6 flex items-center gap-3">
            <Switch id="enableContactForm" checked={formData.enableContactForm} onCheckedChange={(v) => handleInputChange("enableContactForm", v)} />
          ...
          <div>
            ...
            <Input value={formData.mapEmbedUrl} onChange={(e) => handleInputChange("mapEmbedUrl", e.target.value)} />
          </div>
        </section>
        ...
        <section className="border-t border-gray-200 pt-8 pb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Input value={formData.footerText} onChange={(e) => handleInputChange("footerText", e.target.value)} />
            </div>
            <div className="flex items-center gap-3 mt-8 md:mt-0">
              <Switch id="newsletter" checked={formData.newsletterEnabled} onCheckedChange={(v) => handleInputChange("newsletterEnabled", v)} />
