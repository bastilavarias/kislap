...
- `.agents/AGENTS.md`
- `CONTINUITY.md`
- `apps/web-builder/app/(private)/dashboard/builder/linktree/[slug]/components/form.tsx`
...
- `apps/api-service/models/linktree.go`
- `apps/web-admin/database/migrations/2026_03_08_120000_extend_linktree_links_for_custom_sections.php`
- `apps/web-admin/database/migrations/2026_03_08_130000_add_background_style_to_linktrees_table.php`
...
- 2026-03-08 [CODE] Updated `packages/templates/src/components/linktree/index.ts` to export `LinktreeNeoBrutalist`.
- 2026-03-08 [CODE] Updated builder `LAYOUT_OPTIONS` with `Neo Brutalist` option.
